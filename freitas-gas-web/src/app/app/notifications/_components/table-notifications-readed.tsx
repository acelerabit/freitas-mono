...
export function TableNotificationsReaded() {
  ...
  async function fetchNotificationsReaded() {
    const fetchUsersUrl = new URL(
      `${process.env.NEXT_PUBLIC_API_BASE_URL}/notifications/${user?.id}/readed`
    );
